...
sales_by_fy_and_month = sales_by_cust.groupby(['fy', 'month_name'])['total_sales'].sum()
...
titles = ['Top Pairings', 'Item Count by Month', 'Products by Locations and Quarter', 
          'Sales by FY and Month', 'Sales by Fiscal Year', 'Sales by Customer and Month',
